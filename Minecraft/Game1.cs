...
namespace Minecraft
{
    public class Game1 : Game
    {
        ...
        public Game1()
        {
            ...
            IsMouseVisible = true;
            player.Cordinates = new Cordinates(0, 0);
        ...
        static void Get_input(Player plr,Map map)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.W) && map.grid[plr.Cordinates.Y,plr.Cordinates.X] == 0)
            {
                plr.Pos.Y -= speed;
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.S) && map.grid[plr.Cordinates.Y, plr.Cordinates.X] == 0)
            {
                plr.Pos.Y += speed;
                if (plr.Pos.Y % Float_To_int == 0f)
                {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.A) && map.grid[plr.Cordinates.Y, plr.Cordinates.X] == 0)
            {
                plr.Pos.X -= speed;
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.D) && map.grid[plr.Cordinates.Y, plr.Cordinates.X] == 0)
            {
                plr.Pos.X += speed;
                if (plr.Pos.X % Float_To_int == 0f)
                {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.End();
            _spriteBatch.Begin(samplerState: SamplerState.PointClamp);
            _spriteBatch.Draw(player.Texture, player.Grid_pos, null, Color.White, 0f, Vector2.Zero, player.size, SpriteEffects.None, 0f);
            _spriteBatch.End();
            _spriteBatch.Begin(samplerState: SamplerState.PointClamp);
